...
_DELTAARCHIVEMANIFEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='install_operations', full_name='chromeos_update_engine.DeltaArchiveManifest.install_operations',
            index=0,
            number=1, type=11, cpp_type=10, label=3,
            has_default_value=False, default_value=[],
            message_type=None, enum_type=None, containing_type=None,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='chromeos_update_engine.DeltaArchiveManifest.kernel_install_operations', index=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='chromeos_update_engine.DeltaArchiveManifest.dynamic_partition_metadata', index=14,
            number=15, type=11, cpp_type=10, label=1,
            has_default_value=False, default_value=None,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
